...
//                             $("#memListUsers .list-group-user td").on(
//                                 "click",
//                                 function (event) {
//                                     const _self = event.target;
//                                     const userId =
//                                         _self.parentElement.firstElementChild
//                                             .textContent;
//                                     $.ajax({
//                                         type: "GET",
//                                         data: {
...
//                             $("#memListCustomers .list-group-customer td").on(
//                                 "click",
//                                 function (event) {
//                                     const _self = event.target;
//                                     const customerId =
