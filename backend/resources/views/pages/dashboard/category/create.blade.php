<x-app-layout>
    <div class="flex min-h-full mx-6">
        <div class="flex flex-1 flex-col justify-center w-full">
            <div class=" w-full">
                <div>
                    <h2 class="mt-2 text-2xl font-bold leading-9 tracking-tight text-gray-900">Add new category</h2>
                </div>
                <form method="POST" action="{{ route('categories.store') }}" class="" enctype="multipart/form-data">
                    @csrf
