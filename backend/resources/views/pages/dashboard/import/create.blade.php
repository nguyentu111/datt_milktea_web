...
<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto ">
        ...
        <form id='create-import' action="{{ route('imports.store') }}" method="POST" class="">
            @csrf
            <label for="id" class="block  text-sm font-semibold leading-6 uppercase text-slate-700"></label>
            <div class="grid gap-4 grid-cols-6">
                <div @class([ 'col-span-3' , 'grid' , 'grid-cols-3' , 'gap-2' , 'bg-white' , 'p-4' , 'pb-6' , 'rounded-lg' , 'shadow-lg' , 'border-slate-500' , 'border-red-400 border-2'=> $errors->has('user_id')
                    ])
                    class="">
                ...
                <div @class([ 'col-span-3' , 'grid' , 'grid-cols-3' , 'gap-2' , 'bg-white' , 'p-4' , 'pb-6' , 'rounded-lg' , 'shadow-lg' , 'border-slate-500' , 'border-red-400 border-2'=> $errors->has('customer_id')
                    ])
