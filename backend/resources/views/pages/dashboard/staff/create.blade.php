<x-app-layout>
    <div class="flex min-h-full mx-6">
        <div class="flex flex-1 flex-col justify-center w-full">
            <div class=" w-full">
                <div>
                    <h2 class="mt-2 text-2xl font-bold leading-9 tracking-tight text-gray-900">Add new staff</h2>
                </div>
                <form method="POST" action="{{ route('staffs.store') }}" class="" enctype="multipart/form-data">
                    @csrf
                    <div class="flex gap-6">
                        ...
                        <div class="mt-7 border-slate-500 rounded-lg shadow-lg p-6 bg-white w-full">
                            <div class="w-32 h-48 rounded border-2 m-auto">
                                <img src="{{ asset('assets/images/staff-placeholder.jpg') }}" class="object-cover w-full h-full" id="preview" />
                            </div>
                            ...
                            <script>
                                ...
                                selectImage.onchange = evt => {
                                    ...
                                    } else preview.src = "{{ asset('assets/images/staff-placeholder.jpg') }}"
                                }
                            </script>
                            @endpush
                    ...
                    <div class="mt-7 border-slate-500 rounded-lg shadow-lg p-6 bg-white">
                        <div class="grid grid-cols-2 gap-6">
                            ...
                            <div class="flex gap-10">
                                ...
                                <div>
                                    ...
                                    <div class="mt-2 flex gap-3 items-start">
                                        <div>
                                            <div class="flex gap-2 items-center">
                                                <input name="roles[]" id="admin" type="checkbox" value="admin" />
                                                <label for="admin">Admin</label>
                                            </div>
                                            <div class="flex gap-2 items-center">
                                                <input name="roles[]" id="cheff" type="checkbox" value="cheff" />
                                                <label for="cheff">Cheff</label>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="flex gap-2 items-center">
                                                <input name="roles[]" id="warehouse_manager" type="checkbox" value="warehouse_manager" />
                                                <label for="warehouse_manager">Warehouse manager</label>
                                            </div>
                                            <div class="flex gap-2 items-center">
                                                <input name="roles[]" id="business_manager" type="checkbox" value="business_manager" />
                                                <label for="business_manager">Business manager</label>
                                            </div>
                                        </div>

                                        <div class="flex gap-2 items-center">
                                            <input name="roles[]" id="cashier" type="checkbox" value="cashier" />
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="last_name" value="{{ old('last_name')}}" type="last_name" placeholder="Please fill staff last name" />
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="email" value="{{ old('email')}}" type="email" placeholder="Please fill email" />
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="dob" type="date" placeholder="dd-mm-yyyy" value="{{old('dob')}}" />
