    ...
    <div class="flex min-h-full">
        <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div>
                    <h2 class="mt-2 text-2xl font-bold leading-9 tracking-tight text-gray-900">Create new account</h2>
                </div>
                    ...
                    <div>
                        <form method="POST" action="{{ route('users.store') }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="password" type="password" placeholder="Please fill password"></x-bewama::form.input.text>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="password_confirmation" type="password" placeholder="Please confirm password"></x-bewama::form.input.text>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="dob" type="date" value="{{ old('dob')}}" placeholder="dd-mm-yyyy" value=""></x-bewama::form.input.text>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <a href="{{ route('users.index') }}" class="inline-flex  text-white items-center gap-x-2 rounded-md bg-red-500 px-3.5 
                                py-2.5 text-sm font-semibold shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2
                                 focus-visible:outline-primary">
                                    Return import table
                                </a>
