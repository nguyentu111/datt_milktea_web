<x-app-layout>
    <div class="flex min-h-full mx-6">
        <div class="flex flex-1 flex-col justify-center w-full">
            <div class=" w-full">
                <div>
                    <h2 class="mt-2 text-2xl font-bold leading-9 tracking-tight text-gray-900">Update branch</h2>
                </div>
                <form method="POST" action="{{ route('branches.update',$branch) }}" class="" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="flex gap-6">
                        ...
                        <div class="mt-7 border-slate-500 rounded-lg shadow-lg p-6 bg-white w-full @error('picture') border-2 border-red-500 @enderror">
                            <div class="w-full h-48 rounded border-2 m-auto">
                                <img src="{{$branch->picture ??  asset('assets/images/img-placeholder.png') }}" class="object-contain w-full h-full" id="preview" />
                            </div>
                            <input id="branch-picture" name="picture" type="file" accept=".png,.jpg,.jepg" placeholder="Choose pictue" />
                            ...
                            <script>
                                ...
                                const oldPictureUrl = document.getElementById('preview').src;
                                const cancleBtn = document.getElementById('cancle-change-picture');
                                const selectImage = document.getElementById('branch-picture');
                                cancleBtn.onclick = () => {
                    ...
                    <div class="mt-7 border-slate-500 rounded-lg shadow-lg p-6 bg-white">
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="name" value="{{ old('name') ?? $branch->name }}" type="name" placeholder="Please fill name" />
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="address" value="{{ old('address')  ?? $branch->address }}" type="address" placeholder="Please fill address" />
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="phone" value="{{ old('phone') ?? $branch->phone }}" type="phone" placeholder="Please fill phone" />
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <x-bewama::form.input.text name="date_open" type="date" value="{{ old('date_open') ?? $branch->date_open }}" placeholder="dd-mm-yyyy"></x-bewama::form.input.text>
                            ...
                            <div>
                                <div class="mt-2 flex gap-4">
                                    <div class="flex gap-2 items-center">
                                        <input id="active" name="active" value="1" type='radio' @if(old('active') ?? $branch->active ) checked @endif />
                                        <label for="active">Active</label>
                                    </div>
                                    <div class="flex gap-2 items-center">
                                        <input id="unactive" name="active" value="0" type='radio' @if(old('active') !==null ? !old('active') : !$branch->active) checked @endif/>
