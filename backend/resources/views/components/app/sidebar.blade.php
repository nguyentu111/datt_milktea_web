        ...
        <div class="space-y-8">
            ...
            <div>
                <ul class="mt-3">
                    ...
                    <li class="px-3 py-2 hover:bg-slate-600 rounded-sm mb-0.5 last:mb-0 @if(Route::is('orders.index')){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('orders.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Order') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
