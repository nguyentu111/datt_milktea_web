        ...
        <div class="space-y-8">
            ...
            <div>
                <ul class="mt-3">
                        ...
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('categories.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Category') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    ...
                    <li class="px-3 py-2 hover:bg-slate-600 rounded-sm mb-0.5 last:mb-0 @if(Route::is('prices.index')){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('prices.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Price') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    ...
                    <li class="px-3 py-2 hover:bg-slate-600 rounded-sm mb-0.5 last:mb-0 @if(Route::is('promotions.index')){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('promotions.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Promotion') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    ...
                    <li class="px-3 py-2 hover:bg-slate-600 rounded-sm mb-0.5 last:mb-0 @if(Route::is('statistics.index')){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('statistics.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Statistic') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    ...
                    @endif
                    @if(Auth::user()->staff->isWarehouseManager())
                    <li class="px-3 py-2 hover:bg-slate-600 rounded-sm mb-0.5 last:mb-0 @if(Route::is('suppliers.index')){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('suppliers.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Supplier') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        ...
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('imports.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Import') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    ...
                    <li class="px-3 py-2 hover:bg-slate-600 rounded-sm mb-0.5 last:mb-0 @if(Route::is('branch_materials.index')){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('branch_materials.index') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Branch material') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    ...
                    @endif
                    @if(Auth::user()->staff->isCheff())
                    <li class="px-3 py-2 hover:bg-slate-600 rounded-sm mb-0.5 last:mb-0 @if(Route::is('orders.orderCheff')){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('orders.orderCheff') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Order (cheff)') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                    ...
                    @endif
                    @if(Auth::user()->staff->isCashier())
                    <li class="px-3 py-2 hover:bg-slate-600 rounded-sm mb-0.5 last:mb-0 @if(Route::is('orders.orderCashier')){{ 'bg-slate-900' }}@endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150" href="{{ route('orders.orderCashier') }}">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Order (cashier)') }}</span>
                                </div>
                            </div>
                        </a>
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
